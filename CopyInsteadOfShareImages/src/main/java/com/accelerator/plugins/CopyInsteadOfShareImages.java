...
public class CopyInsteadOfShareImages extends Plugin {
    ...
    public static class PluginSettings extends BottomSheet {
        ...
        public void onViewCreated(View view, Bundle bundle) {
            ...
            addView(createCheckedSetting(view.getContext(), "Hide URL in copy toast message", "hideUrlInToast", false));
        }
                ...
                if (shareButton != null)
                {
                    ...
                    shareButton.setOnClickListener( new View.OnClickListener() {
                        ...
                        public void onClick (View v) {
                            ...
                            // Check if we should hide the URL in the toast
                            boolean hideUrlInToast = settings.getBool("hideUrlInToast", false);
                            String toastMessage = hideUrlInToast ? 
                                "Copied URL" : 
                                "Copied " + imageUriFinal;
